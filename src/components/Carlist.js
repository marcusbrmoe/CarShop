...
function Carlist() {
    ...
    const columns = [
        ...
        {headerName: 'Year', field: 'year', sortable: true, filter: true, floatingFilter: true, width: 120},
        {headerName: 'Price', field: 'price', sortable: true, filter: true, floatingFilter: true, width: 120},
        {
            headerName: '', 
            width: 80,
    ...
    const deleteCar = (link) => {
        if (window.confirm('Are you sure?')) {
            ...
            .then(_ => getCars())
            .then(_ => setMsg("Car deleted succesfully"))
            .then(_ => setOpen(true))
            .catch(err => console.error(err))
        }   
    }
    ...
    return (
        <div>
            ...
            <div className="ag-theme-material" style={{height: '650px', width:'95%', margin: 'auto'}}>
                <AgGridReact
                    ref={gridRef}
                    onGridReady={ params => {
